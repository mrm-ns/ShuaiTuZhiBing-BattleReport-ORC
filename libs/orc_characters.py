...
def preprocess_image(image, region=(49,2,151,50)):
    """
    平衡颜色处理的图像预处理
    """
    if region:
...
if __name__ == "__main__":
    ...
    # 测试图像路径
    image_path = r"output\test3_hero_2.jpg"
    ...
    # 角色结果
    match = "✓" if character in character_list else "✗" if character else " "
    print(f"{character:<12} | {confidence:.4f}   | {match}")