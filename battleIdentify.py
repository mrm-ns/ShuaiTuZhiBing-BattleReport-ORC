...
if __name__ == "__main__":
    ...
    checker.check_report(report_list=reports, config=config, debug=config["configuration"]["debug"])
    ...
    for report in reports:
        cha_ty_dic = {
            report.characters[0]: character_type[report.characters[0]],
            report.characters[1]: character_type[report.characters[1]],
            report.characters[2]: character_type[report.characters[2]]
        }
        report.team_type = get_team_type(cha_ty_dic)
